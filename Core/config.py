...
server_config = {
  ...
  'mysql_log_server':   'ismael-pc',#'rh-database',
...
robot_config = {
                ...
                'UH Sunflower': {
							      ...
							      'front_look_right': [-0.5, 0.0, 1.0, -1.0],
							      'front_look_left': [0.5, 0.0, 1.0, -1.0], 
							      'front_bend_right': [0.0, -0.3, 1.0, -1.0],
					                      'front_bend_left': [0.0, 0.3, 1.0, -1.0],  
							      'back': [0.0, 0.0, -1.0, 1.0],
							      'back_look_right': [-0.5, 0.0, -1.0, 1.0],
							      'back_look_left': [0.5, 0.0, -1.0, 1.0],
							      'back_bend_right': [0.0, -0.3, -1.0, 1.0],
					                      'back_bend_left': [0.0, 0.3, -1.0, 1.0],
							      'up': [0.0, 0.0, 1.15, -1.0],
							      'up_look_right': [-0.5, 0.0, 1.15, -1.0],
							      'up_look_left': [0.5, 0.0, 1.15, -1.0] 	  
                                                              }
                                            },
                                   },
                }
