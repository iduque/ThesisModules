...
public class ActivityProperties{
     ...
     private int _id; //Activity Id on the DB
     ...
     private Date _endTime; //Time in which the activity finished
     private Date _startTime; //Time in which the activity started to be recognized
      ...
      */
     public ActivityProperties(int id, Long duration, Double threshold, LinkedHashMap <String,ContextProperties> context,
      ...
      */
    public ActivityProperties(int id) {
        _id = id;
        _threshold = 0.0;
        _location = "";
        _duration = new Long("0");
      ...
      * @param time Time object
      */
     public void setStartTime(Date time) { _startTime = time; }
